  ...
  const projects = useMemo(
    () => [
      ...
      },
      {
        ...
        // pdf: process.env.PUBLIC_URL + "/files/course-portal-report.pdf",
        // ppt: process.env.PUBLIC_URL + "/files/course-portal-slides.pptx",
      },
      {
        title: "Pizza App",
        category: "Development",
      ...
      },
      {
        ...
        tech: ["Pen Tool", "Shape Tool","Pathfinder Tool","Layer Management","Stroke & Fill Editing","Vector Illustration"],
      ...
      },
      {
        ...
        tech: ["High-Fidelity Desktop Wireframe ", " High-Fidelity Mobile Wireframe ", "Page Interactions and Scrolling Behaviours ", "At least 3 Types of Triggers and Animations ", " At least 2 Variables and 2 Conditionals "],
        figma: "https://www.figma.com/design/do5qqSfqTGAuV8zvBmImWX/24011941_CA1quinn?node-id=37-399&t=A9H5NKBwtHaMVESa-1",
      },
      {
        ...
        figma: "https://www.figma.com/design/b6Fi89DP5oQY5eGxwaaX2a/quinn-24011941-Learn-RP-App?node-id=0-1&t=go792g450WDmxmw2-1",
      },
    ...
    <div className="page">
      ...
      <section id="About" className="section">
        <div className="sectionHead">
          ...
          <p className="sectionHint">
            A quick overview of my certified skillsets.
          </p>
        </div>
        ...
        <div className="aboutGrid">
          <div className="panel">
            <p className="text">
              ...
              Polytechnic. I enjoy blending creativity with technology — building
              apps, designing interfaces, and developing immersive VR
              experiences.
            </p>
            <p className="text">
              I’m especially interested in AI, analytics dashboards, and
          ...
          <div className="panel soft">
            <h3 className="panelTitle">What I’m focusing on</h3>

            <ul className="bullet">
              <li>Clean UI + strong usability</li>
              <li>Projects with real-world purpose</li>
              <li>Better storytelling in case studies</li>
              <li>Growing my skills in analytics & VR</li>
            </ul>

            <div className="miniNote">
              <span className="dot" />
              <p>Tip: Click any project image to preview it in a lightbox.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="sectionHead">
          ...
          <p className="sectionHint">
            Tools I’ve used in school projects and practice.
          </p>
        </div>
        ...
        <div className="skillGrid">
          ...
          <div className="skillCard">
            <h3>Design</h3>
            <p>Figma, UI Kits, Adobe Illustrator, Adobe Photoshop</p>
          </div>

          <div className="skillCard">
            <h3>Analytics</h3>
            <p>Power BI, DAX, Dashboards</p>
          </div>
        </div>
      </section>
    ...
    {achievements.map((a) => (
      ...
      <section id="contact" className="section">
        ...
        <div className="contactBox">
          ...
          <p>
            <strong>GitHub:</strong> <span className="muted">(add your GitHub link here)</span>
          </p>
        </div>
      </section>
